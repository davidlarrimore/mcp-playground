...
- **document-mcp**: Unified document generator with `save_uploaded_file`, `create_excel_workbook`, `create_word_report`, and `create_pdf_from_html`. Use for XLSX/DOCX/PDF outputs with download links.
